...
我们，Sunset、lwd-temp、9c5a446d7852de572f319257dc58776e0a72937b8d4dd6cebf286693246f04a5 和 EXPLORER 讨论了一下，决定在这里补充一些事情。
...
那之后我就没太关注了，不过我还是引用她作品中的部分内容在我的项目中，比如这里的描述还有 splash。（编者注：这里指的是[maybe_not_the_last_letter](https://github.com/lwd-temp/maybe_not_the_last_letter)的相关部分）
...
《中国 ██ 大学 2018 年春季学期异常心理学教学大纲》，`2018-02-06 02:10`发布，`2022-09-01 16:20`在 SCP 的爬虫中最后一次出现，`120 (+122 / -2)`。
...
这篇文章`15 Aug 2017`发布，删除于`12 Sep 2022`，发布账号[Hannah_AI](http://www.wikidot.com/user:info/hannah-ai)，抄袭证据完善。根据“不关心一切合著”原则，我和 EXPLORER 认为这是一次合理的处罚。（但由于当时[Hannah_AI](http://www.wikidot.com/user:info/hannah-ai)已被永久封禁，只删除了原文档）
...
- （由于 SCP 中分限制未登录用户访问讨论区，无 Archive，但是 Feed 可以访问）https://web.archive.org/web/20230526132215/http://scp-wiki-cn.wikidot.com/feed/forum/t-15176050.xml
...
- （由于 SCP 中分限制未登录用户访问讨论区，无 Archive，但是 Feed 可以访问）https://web.archive.org/web/20230526122115/http://scp-wiki-cn.wikidot.com/feed/forum/t-2310237.xml
...
<!--
aHR0cHM6Ly9zcGFjZS5iaWxpYmlsaS5jb20vMzYwNzEwNC9keW5hbWlj
aHR0cHM6Ly90LmJpbGliaWxpLmNvbS82OTU2NzM5NDc2NjE3OTUzMzQ=

8cce73c4ae93acacb232ebd02aa5e0283607104.png XOR key: Hannah
-->

<!--
维护提示：本文繁杂而无重点的写作风格是故意为之，不要在页面上可见地提供它的摘要。

但如果你需要一个简明的描述以便理解这篇文档的意义，写在这里：

Hannah_AI 有没有“抄袭”？一定要**非常严格地**判定，有；但和其他的处罚记录相比，很难说。

对 Hannah_AI 的判罚流程有没有问题？有，存在一些疑点。这让我们怀疑，这是否是一个完全*廉洁*的社区管理行为。

最大的疑点是什么？对于《分手》的处罚，我们一致认为，对一篇`2018-02-06 02:10`发布、存活了约 2 个小时就被作者删除的文章，在约两年后发现抄袭并从作者沙盒中找出并处罚，实在是太过*传奇*了。

Hannah_AI 是不是一个“污点作者”？我们认为不是。

Hannah_AI 是个好作者吗？我们认为是。

我们认为自己是中立的吗？不，所以出于良心，我们建议不要完全相信我们的观点。

为什么要写得乱七八糟？因为我们认为，涉事人员或多或少地无法为自己负全责，所以我们不想明确地批评任何人。
-->
