...
live2d_settings['tipsMessage']          = '/assets/live2d/assets/waifu-tips.json';            // 同目录下可省略路径
...
live2d_settings['homePageUrl']          = 'https://sunsets-deprecated-username.github.io';       // 主页地址，可选 'auto'(自动), '{URL 网址}'
live2d_settings['aboutPageUrl']         = 'https://www.fghrsh.net/post/123.html';   // 关于页地址, '{URL 网址}'
live2d_settings['screenshotCaptureName']= 'screenshot.png'; // 看板娘截图文件名，例如 'live2d.png'
